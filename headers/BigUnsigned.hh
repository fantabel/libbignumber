...
/*!
 * \file
 * \brief Fichier qui donne la definition de BigUnsigned.
 */

/*!
 * \brief A BigUnsigned object represents a nonnegative integer of size limited only by
 * available memory.  
 *
 * BigUnsigneds support most mathematical operators and can
...
X BigUnsigned::convertToSignedPrimitive() const {
        std::cout << "convertToSignedPrimitive()" << std::endl;
